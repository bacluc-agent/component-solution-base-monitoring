...
COMPONENT_NAME ?= solution-base-monitoring
...
instance ?= defaults
test_instances = tests/defaults.yml tests/custom-rules.yml tests/test-solution-base-monitoring.yml tests/custom-prefix.yml tests/namespace-thresholds.yml tests/custom-thresholds.yml
